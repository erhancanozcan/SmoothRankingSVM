"""
    srcg_exp_smooth: constant learning rate with exponential smoothing
"""
import numpy as np
from cg.scripts.algs.base_srcg import base_srcg


class srcg_exp_smooth(base_srcg):
    ...
    def __init__(self,train_data,train_class,test_data,test_class,df,df_test,
        ...
        super(srcg_exp_smooth,self).__init__(train_data,train_class,test_data,test_class,df,df_test,
