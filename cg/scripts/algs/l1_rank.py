...
class l1_rank(base_srcg):
    ...
    def __init__(self,train_data,train_class,test_data,test_class,df,df_test,
        ...
        super(l1_rank,self).__init__(train_data,train_class,test_data,test_class,df,df_test,
    ...
    def run(self):
        ...
        obj=(quicksum(errors[f] for f in errors))+ (quicksum(self.lr*self.absweights[i] for i in range(no_points)))
